    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoritesDiscussionId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscussionUser", x => new { x.FavoritesDiscussionId, x.UsersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionUser_Discussions_FavoritesDiscussionId",
                        column: x => x.FavoritesDiscussionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reply_QuestionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "DiscussionId");
                    table.ForeignKey(
                        name: "FK_Messages_Messages_Reply_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Profiles_Signatures_SignatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_Reply_QuestionId",
                table: "Messages",
                column: "Reply_QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Profiles_SignatureId",
                table: "Profiles",
                column: "SignatureId");
